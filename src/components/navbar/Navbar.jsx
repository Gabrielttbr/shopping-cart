            ...
            <div className='container icon-shopping-cart'>
                <Link to='/shopping-cart'>
                    {quantityShoppingCart > 0 ? 
                        (<span className="cart-count">{quantityShoppingCart}</span>)
                    : <></>
                    }
                    <svg xmlns='http://www.w3.org/2000/svg' width='35' height='35' color='#fff' fill='currentColor' className='bi bi-cart4' viewBox='0 0 16 16'>
